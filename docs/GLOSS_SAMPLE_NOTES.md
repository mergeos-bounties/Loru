...
Cycle wave2: fingerspell_h gloss with unique synthetic frames.

Cycle wave2: fingerspell_g gloss with unique synthetic frames.

Cycle wave2: fingerspell_f gloss with unique synthetic frames.

Cycle wave2: fingerspell_e gloss with unique synthetic frames.

Cycle wave2: fingerspell_d gloss with unique synthetic frames.

Cycle wave2: fingerspell_c gloss with unique synthetic frames.

Cycle wave2: fingerspell_b gloss with unique synthetic frames.

Cycle wave2: fingerspell_a gloss with unique synthetic frames.
